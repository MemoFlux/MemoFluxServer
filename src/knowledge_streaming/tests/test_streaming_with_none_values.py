...
@pytest.mark.asyncio
async def test_process_from_text_stream_with_none_values(
    knowledge_processor, sample_text, sample_tags
):
...
@pytest.mark.asyncio
async def test_process_from_text_stream_with_empty_lists(
    knowledge_processor, sample_text, sample_tags
):
